...
import net.gabriel.picklecraft.block.custom.PickleCraftBarrel;
...
public class PickleCraftBlocks {
    ...
    public static final RegistryObject<Block> PICKLECRAFT_BARREL = BLOCKS.register("picklecraft_barrel", () -> new PickleCraftBarrel(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD)));
