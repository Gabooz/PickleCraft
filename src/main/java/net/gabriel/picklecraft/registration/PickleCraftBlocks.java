...
import net.gabriel.picklecraft.block.custom.Barrel;
...
public class PickleCraftBlocks {
    ...
    public static final RegistryObject<Block> BARREL = BLOCKS.register("barrel", () -> new Barrel(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD)));
